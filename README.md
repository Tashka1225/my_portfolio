...
<ol>
  ...
  <p><em><strong>Задача №2:</strong></em> Дополнить код запроса SQL из Задачи №1 таким образом, чтобы получились винтажные доходимости клиентов для каждого партнера. Вывести полученные результаты в Excel, сделать визуализацию.
</ol>
